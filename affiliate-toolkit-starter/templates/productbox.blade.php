...
?>
<div class="atkp-container atkp-productbox-box {{$parameters->get_css_container_class()}}">
    @if($products != null)
            ...
            <div class="atkp-box atkp-clearfix {{$parameters->get_css_element_class()}}"
                ...
                <div class="atkp-content">
                    ...
                    @if($product->variations != '' && count($product->variations) > 0)
                        @include('variationboxes',['formatter' => $formatter, 'translator' => $translator, 'product' => $product, 'parameters' =>$parameters])
                    @endif
