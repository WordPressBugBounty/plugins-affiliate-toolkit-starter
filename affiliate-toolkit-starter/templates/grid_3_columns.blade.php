...
?>
<div class="atkp-container atkp-grid_3_columns-box {{$parameters->get_css_container_class()}}">
    @if($products != null)
        <div class="atkp-clearfix atkp-box-3-cols {{$parameters->get_css_element_class()}}">
