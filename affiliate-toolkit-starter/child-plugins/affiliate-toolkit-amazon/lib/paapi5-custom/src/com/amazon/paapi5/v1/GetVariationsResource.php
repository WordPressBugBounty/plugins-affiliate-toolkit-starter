...
class GetVariationsResource
{
    ...
    const OFFERSLISTINGSAVAILABILITYMAX_ORDER_QUANTITY = 'OffersV2.Listings.Availability.MaxOrderQuantity';
    const OFFERSLISTINGSAVAILABILITYMESSAGE = 'OffersV2.Listings.Availability.Message';
    const OFFERSLISTINGSAVAILABILITYMIN_ORDER_QUANTITY = 'OffersV2.Listings.Availability.MinOrderQuantity';
    const OFFERSLISTINGSAVAILABILITYTYPE = 'OffersV2.Listings.Availability.Type';
    const OFFERSLISTINGSCONDITION = 'OffersV2.Listings.Condition';
    const OFFERSLISTINGSCONDITIONCONDITION_NOTE = 'OffersV2.Listings.Condition.ConditionNote';
    const OFFERSLISTINGSCONDITIONSUB_CONDITION = 'OffersV2.Listings.Condition.SubCondition';
    const OFFERSLISTINGSDELIVERY_INFOIS_AMAZON_FULFILLED = 'OffersV2.Listings.DeliveryInfo.IsAmazonFulfilled';
    const OFFERSLISTINGSDELIVERY_INFOIS_FREE_SHIPPING_ELIGIBLE = 'OffersV2.Listings.DeliveryInfo.IsFreeShippingEligible';
    const OFFERSLISTINGSDELIVERY_INFOIS_PRIME_ELIGIBLE = 'OffersV2.Listings.DeliveryInfo.IsPrimeEligible';
    const OFFERSLISTINGSDELIVERY_INFOSHIPPING_CHARGES = 'OffersV2.Listings.DeliveryInfo.ShippingCharges';
    const OFFERSLISTINGSIS_BUY_BOX_WINNER = 'OffersV2.Listings.IsBuyBoxWinner';
    const OFFERSLISTINGSLOYALTY_POINTSPOINTS = 'OffersV2.Listings.LoyaltyPoints.Points';
    const OFFERSLISTINGSMERCHANT_INFO = 'OffersV2.Listings.MerchantInfo';
    const OFFERSLISTINGSPRICE = 'OffersV2.Listings.Price';
    const OFFERSLISTINGSPROGRAM_ELIGIBILITYIS_PRIME_EXCLUSIVE = 'OffersV2.Listings.ProgramEligibility.IsPrimeExclusive';
    const OFFERSLISTINGSPROGRAM_ELIGIBILITYIS_PRIME_PANTRY = 'OffersV2.Listings.ProgramEligibility.IsPrimePantry';
    const OFFERSLISTINGSPROMOTIONS = 'OffersV2.Listings.Promotions';
    const OFFERSLISTINGSSAVING_BASIS = 'OffersV2.Listings.SavingBasis';
    const OFFERSSUMMARIESHIGHEST_PRICE = 'OffersV2.Summaries.HighestPrice';
    const OFFERSSUMMARIESLOWEST_PRICE = 'OffersV2.Summaries.LowestPrice';
    const OFFERSSUMMARIESOFFER_COUNT = 'OffersV2.Summaries.OfferCount';
